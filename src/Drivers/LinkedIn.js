...
class LinkedIn extends OAuth2Scheme {
  ...
  async getUser (queryParams, originalState) {
    ...
    const email = await this._getEmail(accessTokenResponse.accessToken)
    userProfile.emailAddress = email.elements[0]["handle~"].emailAddress
